...
| `token`      | `string`   | optional | The **hex address** of the token to swap in exchange for the `baseToken`. If specified, the user will not be able to search for any other tokens in the widget.                                                                                       |
