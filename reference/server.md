Servers are processes that implement the [Quote](../protocols/quote.md) and [Order](../protocols/order.md) APIs using [JSON-RPC 2.0](http://www.jsonrpc.org/specification) over HTTPS.
